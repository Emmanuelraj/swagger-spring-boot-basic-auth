...
public class ProductRepository {
    ...
    private ProductDto generateProduct() {
    	...
    	return new ProductDto(dummy.identifier().uuid(), dummy.lorem().word() + " " + dummy.lorem().word(), dummy.color().name(), 
    			dummy.identifier().ean13(), dummy.nation().country(), dummy.finance().priceBuilder().withCurrency("USD").build(), dummy.number().nextInt(1, 200));
